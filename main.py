...
def Send_Mess():
    ...
    app.send_message(client,
                     f'Привет, я бот! Мой создатель всего-лишь хотел напомнить что ты ему должен {cash}. Уже прошло {days()} {plural_days()}. Ахуеть можно. Во всяком случае держи мемес на английском :)')
